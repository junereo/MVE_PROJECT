...
router.post("/c/:surveyId", verifyUserOrAdmin, verifyToken, calculateSurveyResultHandler);
...
router.put("/t/:surveyId", verifyUserOrAdmin, verifyToken, terminateSurveyHandler);
