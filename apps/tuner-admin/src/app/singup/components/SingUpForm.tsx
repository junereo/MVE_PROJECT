...
const SingUpForm = () => {
    ...
    const pushOauth = async (formData: any) => {
        const res = await axiosInstance.post('/adminRegister', formData)
        return res.data
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#ffffff]">
            <div className="w-96 bg-black bg-opacity-80 p-8 rounded-lg shadow-md text-white">
                <div className="flex flex-col items-center mb-6">
                    <h2 className="text-2xl font-semibold text-white pb-2">Sing Up</h2>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="w-full bg-[#4a6ea9] py-2 rounded font-semibold hover:bg-[#3d5e93]">
                        가입하기
                    </button>
                </form>
