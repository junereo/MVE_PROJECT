          ...
          <div className="flex-1 flex flex-col space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 space-y-2">
                <p>
                  👤 작성자: {surveyData.creator.nickname} (ID:{" "}
                  {surveyData.creator.id})
                </p>
                <p>
                  📘 설문 유형:{" "}
                ...
                <p>💰 총 리워드: {surveyData.reward_amount} STK</p>
                <p>
                  지급 완료: 0 STK / 잔여: {surveyData.reward_amount} STK
                  <br />
                        ...
                        {answerCount.map(({ option, count }, idx) => {
                          ...
                          return (
                            <li key={idx} className="flex items-center gap-2">
                              <span className="w-1/4">{option}</span>
