...
const SurveyStep1 = () => {
  ...
  */
  ...
  // 처음 로딩 시 step1에 유튜브 정보 저장 shadow rounded 이거는 따로따로 있는거야?
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <div className="p-6 w-[50%]  sm:p-6 md:p-8 shadow rounded">
        {/* 유튜브 영상 등록 버튼 */}
        <button
        ...
        {step1.youtubeVideoId && (
          <div className="mt-4">
            ...
            {/* 아티스트명 입력 */}
            <div className="font-bold text-lg sm:text-xl mt-4">아티스트</div>
            <input
              placeholder={`${
                step1.channelTitle || "아티스트명을 입력해주세요"
              }`}
              value={step1.artist || ""}
      ...
      /> */}
        ...
        {/* 다음 단계로 이동 */}
        <button
          onClick={() => router.push("/survey/create/step2")}
